...
def post_kb():
    # 3 ta tugma — chap, o'rta (WebApp), o'ng
    # Hammasi "primary" (ko'k) — yon joy ko'rinmaydi
    keyboard = [[
        {"text": "🔵", "callback_data": "noop", "style": "primary"},
        {"text": "📝  Post yaratish  ", "web_app": {"url": WEBAPP_URL}, "style": "primary"},
        {"text": "🔵", "callback_data": "noop", "style": "primary"},
    ]]
